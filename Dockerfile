...
ARG TARGETARCH
ARG VERSION
RUN CGO_ENABLED=0 GOOS=linux GOARCH=${TARGETARCH} go build -ldflags="-w -s -X github.com/divmora/otel-aws-log-parser/pkg/sender.Version=${VERSION}" -o bootstrap ./cmd/lambda
